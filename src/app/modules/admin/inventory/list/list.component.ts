import { products } from './../../../../mock-api/pages/activities/data';
...
export class NotesListComponent implements OnInit, OnDestroy {
    ...
    products$: Observable<Product[]> = this._notesService.getProducts();
    ...
    ngOnInit(): void {
        ...
        this._notesService.getProducts().subscribe();
        ...
        this.products$ = combineLatest([
            this._notesService.products$,
            this.filter$,
            this.searchQuery$,
        ]).pipe(
            distinctUntilChanged(),
            map(([products, filter, searchQuery]) => {
                ...
                if (filter.startsWith('label:')) {
                    ...
                    filteredProducts = filteredProducts.filter(
                        (product) =>
                            !!product.labels.find((item) => item.id === labelId)
                    );
                }
